...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"zh2coinaddress\"\n"
            "\nReveals the private key corresponding to 'zh2coinaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"zh2coinaddress\"   (string, required) The zh2coin address for the private key\n"
            "\nResult:\n"
