...
const QString BITCOIN_IPC_PREFIX("zh2coin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/zh2coin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/zh2coin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/zh2coin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click zh2coin: links
...
//
// OSX-specific way of handling zh2coin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in zh2coin: URIs
