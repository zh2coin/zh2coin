...
#if defined(NDEBUG)
# error "Zh2Coin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Zh2Coin Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Zh2Coin also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // Zh2Coin also requires low S in sigs
