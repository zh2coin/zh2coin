...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/zh2coin/zh2coin>";
    const std::string URL_WEBSITE = "<https://zh2coin.com/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The Zh2Coin Developers", 2021)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find Zh2Coin useful. "
